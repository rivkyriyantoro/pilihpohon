	...
	<div class="container mb-5 mt-5">
		<div class="card border-0 shadow">
			<div class="card-header">
				<h3 class="text-center">Tambah Informasi</h3>
			</div>
			...
			<form class="container mt-5 mb-5 p-4" action="" method="POST" enctype="multipart/form-data">
				...
				<div class="mb-3">
					...
					<input type="text" name="judul" placeholder="Judul Informasi..." class="form-control" autocomplete="off" required>
				</div>
				...
				<button type="button" class="btn btn-secondary" onclick="window.location = 'informasi.php'">Kembali</button>
